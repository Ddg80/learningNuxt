        ...
        <div class="flex flex-wrap items-center justify-between -mx-4">
          ...
          <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div class="mt-10 lg:mt-0">
              <span class="block mb-4 text-lg font-semibold text-blue-600"> Why Choose Us </span>
              ...
              <NuxtLink
                to="/"
                class="inline-flex items-center justify-center py-3 text-base font-medium text-center text-white border border-transparent rounded-md px-7 bg-gradient-to-r from-blue-300 to-blue-600 hover:bg-opacity-90"
              >
                Go to home
              </NuxtLink>
            </div>
